...
This repository is based on the [Optimizely Content JS SDK Next.js Template](https://github.com/episerver/content-js-sdk/tree/main/samples/nextjs-template).

Original work Copyright 2025 Optimizely  
